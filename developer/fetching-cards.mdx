...
|---|---|---|
| `profile.json` | JSON | Skills, experience, seniority, domains |
| `rules.yaml` | YAML | Compensation floor, remote policy, blocked industries |
| `evidence.json` | JSON | Verifiable links: repos, certs, portfolio, publications |
